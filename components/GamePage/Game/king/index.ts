...
export default class king {
    ...
    public build(scene: Scene) {
        ...
        //     // Only needed if the game is in mega prize machine mode
        //     if (!this.isMega) {
        //         getMeshByName("mega", (mesh) => {
        //             mesh.isVisible = false;
        //         });

        //         getMeshByName("mega_e", (mesh) => {
        //             mesh.isVisible = false;
        //         });

        //         getMeshByName("mega_g", (mesh) => {
        //             mesh.isVisible = false;
        //         });

        //         getMeshByName("mega_a", (mesh) => {
        //             mesh.isVisible = false;
        //         });

        //         getMeshByName("mega_head_outer", (mesh) => {
        //             mesh.isVisible = false;
        //         });

        //         getMeshByName("mega_head_inner", (mesh) => {
        //             mesh.isVisible = false;
        //         });
        //     }
